...
from persepolis.gui.after_download_ui import AfterDownloadWindowUi
...
class AfterDownloadWindow(AfterDownloadWindowUi):
    def __init__(self, parent: QWidget, download_dict: dict[str, Any], persepolis_setting: QSettings) -> None:
        ...
        size = self.persepolis_setting.value('AfterDownloadWindow/size', QSize(659, 300))
