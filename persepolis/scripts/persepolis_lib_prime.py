...
from persepolis.scripts.useful_tools import (convertTime, humanReadableSize, freeSpace, headerToDict, readCookieJar,
                                             getFileNameFromLink, returnNewFileName, nowDate, sigmaTime, nowTime)
...
class Download():
    def __init__(self, add_link_dictionary, main_window, gid):
        ...
        # download_status can be in waiting, scheduled, downloading, stop, error, paused, creating download file
