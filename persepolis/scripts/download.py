...
def findDownloadPath(file_name, download_path, subfolder):
    ...
    # audio formats
    audio = ['act', 'aiff', 'aac', 'amr', 'ape', 'au', 'awb', 'dct', 'dss', 'dvf', 'flac', 'gsm', 'iklax', 'ivs', 'it',
             'm4a', 'm4p', 'mid', 'mmf', 'mp3', 'mpc', 'msv', 'ogg', 'oga', 'opus', 'ra', 'raw', 'sln', 'tta', 'vox',
             'wav', 'wma', 'wv', 'xm']
    ...
    # program formats
    program = ['air', 'apk', 'apks', 'apkm', 'app', 'AppImage', 'AppxBundle', 'appx', 'aur', 'deb', 'dmg', 'exe', 'flatpak', 'nexe', 'jar',
               'msc', 'msi', 'msix'， 'msixbundle', 'msu', 'nupkg', 'pacman', 'pkg', 'run', 'rpm', 'snap', 'xap', 'xapk']
