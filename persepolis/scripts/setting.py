...
from persepolis.gui.setting_ui import KeyCapturingWindowUi, SettingUi
...
class KeyCapturingWindow(KeyCapturingWindowUi):
...
class PreferencesWindow(SettingUi):
    def __init__(self, parent: QWidget, persepolis_setting: QSettings) -> None:
        ...
        self.chunk_size_spinBox.setValue(int(self.persepolis_setting.value('chunk-size')))
        ...
        # video_finder
        try:  # Integer casting may raise exception.  # noqa: SIM105
        ...
        size = self.persepolis_setting.value('PreferencesWindow/size', QSize(578, 597))
    ...
    def setDarkLightIcon(self, _index: int | None = None) -> None:
        ...
        if dark_theme is True:
            ...
            if selected_size < 48:  # noqa: SIM108, PLR2004
    ...
    def fontCheckBoxState(self, _checkBox: bool) -> None:
    ...
    def soundFrame(self, _checkBox: bool) -> None:
    ...
    def okPushButtonPressed(self, _button: QPushButton) -> None:
        ...
        self.persepolis_setting.setValue('chunk-size', self.chunk_size_spinBox.value())
        ...
        for key in self.first_key_value_dict:
            if self.first_key_value_dict[key] != self.second_key_value_dict[key]:  # noqa: SIM102
                if key in [
                    'locale',
                    'download_path',
                    'custom-font',
