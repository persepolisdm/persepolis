...
class AboutWindowUi(QWidget):
    def __init__(self, persepolis_setting: QSettings) -> None:
        ...
        self.acknowledgments_ytdlp_label.setText(
            QCoreApplication.translate(
                'about_ui_tr',
        ...
        self.acknowledgments_ffmpeg_label.setText(
            QCoreApplication.translate(
                'about_ui_tr',
        ...
        self.acknowledgments_pyside_label.setText(
            QCoreApplication.translate(
                'about_ui_tr',
        ...
        self.acknowledgments_pyton_requests_label.setText(
            QCoreApplication.translate(
                'about_ui_tr',
        ...
        self.about_tabWidget.addTab(
            self.acknowledgments_tab, QCoreApplication.translate('about_ui_tr', 'Acknowledgments')
        )
