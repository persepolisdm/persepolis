...
# Youtube options tab
        ...
        # youtube_dl_path_label
        self.youtube_dl_path_label = QLabel(self.layoutWidgetYTD)
        self.youtube_dl_path_label.setText('Where is "youtube-dl" executable :')
        self.youtube_verticalLayout.addWidget(self.youtube_dl_path_label)
        # youtube_dl_path_lineEdit
        self.youtube_dl_path_lineEdit = QLineEdit(self.layoutWidgetYTD)
        self.youtube_dl_path_horizontalLayout.addWidget(self.youtube_dl_path_lineEdit)
        # youtube_dl_path_pushButton
        self.youtube_dl_path_pushButton = QPushButton(self.layoutWidgetYTD)
        self.youtube_dl_path_pushButton.setText('Browse')
        self.youtube_dl_path_horizontalLayout.addWidget(self.youtube_dl_path_pushButton)
        self.youtube_verticalLayout.addLayout(self.youtube_dl_path_horizontalLayout)
        ...
        self.setting_tabWidget.addTab(self.youtube_tab, "Youtube Options")
