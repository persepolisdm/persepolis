...
# Youtube options tab
        self.setting_tabWidget.setTabText(self.setting_tabWidget.indexOf(
            self.youtube_tab),  QCoreApplication.translate("setting_ui_tr", "Youtube Options"))

        self.enable_ytd_checkbox.setText(QCoreApplication.translate("setting_ui_tr", 'Enable Youtube Downloader'))
