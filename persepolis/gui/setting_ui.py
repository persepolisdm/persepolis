...
from PyQt5.QtWidgets import QAbstractItemView, QTableWidget, QTableWidgetItem, QDateTimeEdit, QCheckBox, QVBoxLayout, \
    QHBoxLayout, QFrame, QWidget, QLabel, QLineEdit, QTabWidget, QSpinBox, QPushButton, QDial, QComboBox, QFontComboBox, \
...
class Setting_Ui(QWidget):
    def __init__(self, persepolis_setting):
        ...
        self.wait_queue_label.setText(
            QCoreApplication.translate("setting_ui_tr", 'Wait between every downloads in queue:'))
        ...
        aria2_path_tooltip = QCoreApplication.translate("setting_ui_tr",
        ...
        self.subfolder_checkBox.setText(QCoreApplication.translate("setting_ui_tr",
